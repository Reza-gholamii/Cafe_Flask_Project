...
$("#new_order-button").on("click", function () {
    $("#table_body tr").filter(function () {
        $(this).toggle($(this).text().indexOf("جدید") > -1)
    });

});

$("#cooking-button").on("click", function () {
    $("#table_body tr").filter(function () {
        $(this).toggle($(this).text().indexOf("در حال پخت") > -1)
    });

});

$("#serving-button").on("click", function () {
    $("#table_body tr").filter(function () {
        $(this).toggle($(this).text().indexOf("سرو شده") > -1)
    });
...
$("#canceled-button").on("click", function () {
    $("#table_body tr").filter(function () {
        $(this).toggle($(this).text().indexOf("کنسل شده") > -1)
    });
});
